...
class Section(nn.Module):
    ...
    def setup(self,classifier):
        ...
        #NextStepClassifier(self.input_features_shape,self.num_total_layers,self.num_options_each_layer,self.step_classifier_encoder)
    ...
    def forward(self,next_steps:NextSteps,args,update=lambda output,args:output):
