...
class Task:
    def __init__(self,dummy,device,sections:list) -> None:
       
        #print(input_shape)
        self.device=device
        #self.dummy_input=torch.zeros(1,*input_shape)
        self.dummy_input=dummy
        self.dummy_features=dummy
        ...
        self.steps_classifiers=[]
        self.share=None 
        self.custom_forward=None
   
    def append_section(self,section:Section,classifier):
        ...
        self.steps_classifiers.append(section.classifier)
        section.tasks.update({weakref.ref(self):len(self.sections)})
    ...
    def forward(self,data):
        ...
        for section in self.sections:
           ...
           # print("section.input_features_size",section.input_features_size)
            ...
            last_section_steps=self.steps_classifiers.forward(last_features,last_section_steps,self)
        ...
        return data
    def custom_forward(self,args,forward):
        pass
    # def forward(self,data):
    #     # print("task vars",vars(self))
    #     # print("----------------------------------")
    ...
    def optimize_parameters(self,loss,previous_steps=None):
