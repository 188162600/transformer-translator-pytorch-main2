...
from models.transformer_model import TransformerModel, TransformerModel2
...
if __name__ == "__main__":
    ...
    model = TransformerModel2(opt)  # create a dataset given opt.dataset_mode and other options
